...
if mode_enabled window; then
  check_file "comment_attachment" "tests/results_comment_attachment.csv" 6 7 2 3 4
  check_file "graph_validation" "tests/results_graph_validation.csv" 8 9 2 3 4
  check_file "recursive_layout" "tests/results_recursive_layout.csv" 8 9 2 3 4
  check_file "recursive_layout_layered" "tests/results_recursive_layout_layered.csv" 8 9 2 3 4
  check_file_per_scenario "recursive_layout_scenarios" "tests/results_recursive_layout_scenarios.csv" 9 10 2 6 7
  check_file_per_scenario "layered_issue_scenarios" "tests/results_layered_issue_scenarios.csv" 6 7 2 3 4
fi
