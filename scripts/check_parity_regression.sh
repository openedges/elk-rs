...
if mode_enabled window; then
  check_file "comment_attachment" "parity/results_comment_attachment.csv" 6 7 2 3 4
  check_file "graph_validation" "parity/results_graph_validation.csv" 8 9 2 3 4
  check_file "recursive_layout" "parity/results_recursive_layout.csv" 8 9 2 3 4
  check_file "recursive_layout_layered" "parity/results_recursive_layout_layered.csv" 8 9 2 3 4
  check_file_per_scenario "recursive_layout_scenarios" "parity/results_recursive_layout_scenarios.csv" 9 10 2 6 7
  check_file_per_scenario "layered_issue_scenarios" "parity/results_layered_issue_scenarios.csv" 6 7 2 3 4
fi
