...
- `run_java_phase_trace.sh [models_root] [output_dir]` (exports Java layered phase snapshots as `step_*.json`; supports JSON input roots such as `perf/model_parity/java/input`)
