...
LAYERED_ISSUE_OUTPUT=${LAYERED_ISSUE_OUTPUT:-parity/results_layered_issue_scenarios.csv}
...
JAVA_PARITY_SCENARIO_THRESHOLDS_FILE=${JAVA_PARITY_SCENARIO_THRESHOLDS_FILE:-parity/java_parity_thresholds.csv}
JAVA_BASELINE_FILE=${JAVA_BASELINE_FILE:-parity/baselines/java_layered_issue_scenarios.csv}
JAVA_BASELINE_OUTPUT=${JAVA_BASELINE_OUTPUT:-parity/java_vs_rust_baseline.md}
