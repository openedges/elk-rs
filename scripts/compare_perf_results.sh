...
if mode_enabled window; then
  ...
  compare_per_scenario_window "recursive_layout_scenarios" "perf/results_recursive_layout_scenarios.csv" 9 10 2 6 7
  compare_per_scenario_window "layered_issue_scenarios" "perf/results_layered_issue_scenarios.csv" 6 7 2 3 4
fi
