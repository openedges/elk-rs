...
pub struct ScConnectivityCycleBreaker;

impl ScConnectivityCycleBreaker {
    pub fn new() -> Self {
        ScConnectivityCycleBreaker
    }
...
impl Default for ScConnectivityCycleBreaker {
    fn default() -> Self {
        Self::new()
    }
}

impl ILayoutPhase<LayeredPhases, LGraph> for ScConnectivityCycleBreaker {
