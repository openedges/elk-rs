...
use org_eclipse_elk_core::org::eclipse::elk::core::util::elk_spacings::SpacingFactor;
...
impl LayeredSpacings {
    pub fn with_base_value(base_spacing: f64) -> LayeredSpacingsBuilder {
        LayeredSpacingsBuilder::new(base_spacing)
    }
}
...
impl LayeredSpacingsBuilder {
    ...
    fn dependent_spacing_options() -> &'static [&'static LazyLock<Property<f64>>] {
        static OPTIONS: [&LazyLock<Property<f64>>; 13] = [
    ...
    pub fn apply_to_properties(&self, props: &mut MapPropertyHolder) {
        self.build().apply_to_properties(props);
    }
}
