...
pub struct NeatoOptions;

impl NeatoOptions {
    pub const ALGORITHM_ID: &'static str = "org.eclipse.elk.graphviz.neato";
    ...
    pub const RANDOM_SEED: &'static LazyLock<Property<i32>> = GraphvizOptions::RANDOM_SEED;
    pub const INTERACTIVE: &'static LazyLock<Property<bool>> = GraphvizOptions::INTERACTIVE;
    pub const SEPARATE_CONNECTED_COMPONENTS: &'static LazyLock<Property<bool>> =
        GraphvizOptions::SEPARATE_CONNECTED_COMPONENTS;
}
