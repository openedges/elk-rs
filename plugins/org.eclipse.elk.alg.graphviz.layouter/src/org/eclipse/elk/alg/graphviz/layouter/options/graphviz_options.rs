...
pub static ADAPT_PORT_POSITIONS_PROPERTY: LazyLock<Property<bool>> = LazyLock::new(|| {
    Property::with_default("org.eclipse.elk.graphviz.adaptPortPositions", true)
});

pub static CONCENTRATE_PROPERTY: LazyLock<Property<bool>> = LazyLock::new(|| {
    Property::with_default("org.eclipse.elk.graphviz.concentrate", false)
});
...
impl GraphvizOptions {
    pub const ADAPT_PORT_POSITIONS: &'static LazyLock<Property<bool>> = &ADAPT_PORT_POSITIONS_PROPERTY;
    ...
    pub const LAYER_SPACING_FACTOR: &'static LazyLock<Property<f64>> = &LAYER_SPACING_FACTOR_PROPERTY;
    ...
    pub const PADDING: &'static LazyLock<Property<org_eclipse_elk_core::org::eclipse::elk::core::math::ElkPadding>> =
        CoreOptions::PADDING;
    pub const DIRECTION: &'static LazyLock<Property<org_eclipse_elk_core::org::eclipse::elk::core::options::Direction>> =
    ...
    pub const NODE_SIZE_OPTIONS: &'static LazyLock<Property<org_eclipse_elk_core::org::eclipse::elk::core::util::EnumSet<org_eclipse_elk_core::org::eclipse::elk::core::options::size_options::SizeOptions>>> =
        CoreOptions::NODE_SIZE_OPTIONS;
    pub const EDGE_ROUTING: &'static LazyLock<Property<org_eclipse_elk_core::org::eclipse::elk::core::options::EdgeRouting>> =
