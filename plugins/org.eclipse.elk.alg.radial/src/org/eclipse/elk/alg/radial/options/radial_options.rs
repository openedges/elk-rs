...
pub static ROTATION_OUTGOING_EDGE_ANGLES_PROPERTY: LazyLock<Property<bool>> =
    LazyLock::new(|| {
        Property::with_default(
...
pub static COMPACTOR_PROPERTY: LazyLock<Property<CompactionStrategy>> =
    LazyLock::new(|| Property::with_default("org.eclipse.elk.radial.compactor", CompactionStrategy::None));
...
pub static SORTER_PROPERTY: LazyLock<Property<SortingStrategy>> =
    LazyLock::new(|| Property::with_default("org.eclipse.elk.radial.sorter", SortingStrategy::None));

pub static WEDGE_CRITERIA_PROPERTY: LazyLock<Property<AnnulusWedgeCriteria>> =
    LazyLock::new(|| {
        Property::with_default("org.eclipse.elk.radial.wedgeCriteria", AnnulusWedgeCriteria::NodeSize)
    });
...
impl RadialOptions {
    ...
    pub const ROTATION_TARGET_ANGLE: &'static LazyLock<Property<f64>> = &ROTATION_TARGET_ANGLE_PROPERTY;
    ...
    pub const COMPACTION_STEP_SIZE: &'static LazyLock<Property<i32>> = &COMPACTION_STEP_SIZE_PROPERTY;

    pub const SORTER: &'static LazyLock<Property<SortingStrategy>> = &SORTER_PROPERTY;
    pub const WEDGE_CRITERIA: &'static LazyLock<Property<AnnulusWedgeCriteria>> = &WEDGE_CRITERIA_PROPERTY;
    pub const OPTIMIZATION_CRITERIA: &'static LazyLock<Property<RadialTranslationStrategy>> =
        &OPTIMIZATION_CRITERIA_PROPERTY;

    pub const POSITION: &'static LazyLock<Property<org_eclipse_elk_core::org::eclipse::elk::core::math::KVector>> =
    ...
    pub const PADDING: &'static LazyLock<Property<org_eclipse_elk_core::org::eclipse::elk::core::math::ElkPadding>> =
        CoreOptions::PADDING;
    pub const MARGINS: &'static LazyLock<Property<org_eclipse_elk_core::org::eclipse::elk::core::math::ElkMargin>> =
        CoreOptions::MARGINS;
