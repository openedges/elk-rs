...
- manifest: `perf/model_parity_step49_prevcode/rust_manifest.tsv`
- total rows: 41
- compared rows: 41
- matched rows: 1
- drift rows: 40
...
- total diffs across all models: 690
...
- `children[*]/y`: 368 (53.3%)
- `edges[*]/sections[*]/bendPoints[*]`: 136 (19.7%)
...
- `children[*]/children[*]/y`: 10 (1.4%)
- `edges[*]/sections[*]/id`: 4 (0.6%)
