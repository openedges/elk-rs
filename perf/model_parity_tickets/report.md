...
- `children[*]/children[*]/y`: 13 (32.5%)
- `children[*]/children[*]/children[*]`: 12 (30.0%)
- `children[*]/children[*]/x`: 11 (27.5%)
- `children[*]/children[*]/labels[*]`: 2 (5.0%)
- `children[*]/children[*]/width`: 2 (5.0%)
...
- `tickets/layered/701_portLabels.elkt`: diffs=20 [coordinate=14, label=6], first: children[0]/children[0]/children[0]/labels[0]/x: number mismatch (38.0 != 5.0)
